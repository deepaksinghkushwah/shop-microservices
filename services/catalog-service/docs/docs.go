...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.CreateAttributeRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.CreateAttributeValueRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.CreateImageRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/products/{id}/attributes": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Attribute Assignment Data",
                        "name": "attribute",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.AssignAttributeRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        "handler.AssignAttributeRequest": {
            "type": "object",
            "properties": {
                "attribute_id": {
                    "type": "integer",
        ...
        "handler.CreateAttributeRequest": {
            "type": "object",
            "properties": {
                "name": {
                    "type": "string",
        ...
        "handler.CreateAttributeValueRequest": {
            "type": "object",
            "properties": {
                "value": {
                    "type": "string",
